...
export class DataSetGrid implements ComponentFramework.StandardControl<IInputs, IOutputs> {
    ...
    private onRowClick(event: Event): void {
        ...
        if (rowRecordId) {    
            const entityName = (this.contextObj.mode as any).contextInfo.entityTypeName;
            const entityId = this.contextObj.parameters.dataSetGrid.records[rowRecordId]?.getRecordId() || "";
